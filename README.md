...
```bash
# 1. Clone the repo
git clone https://github.com/sanjux-xx/CostShot.git
cd CostShot
...
- 🌐 [productcamparison.live](https://productcamparison.live) — Live website
